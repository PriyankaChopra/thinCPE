 ...
 */
package org.opendaylight.datapathFirewall.cli.commands;
...
public class PackethandlerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PackethandlerCliTestCommand.class);
    protected final PackethandlerCliCommands service;

    public PackethandlerCliTestCommand(final PackethandlerCliCommands service) {
